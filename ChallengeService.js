    ...
    return co(function* (){
      ...
      metadata_response.forEach(function(metadatum_result){
        if(metadatum_result.status == 'error'){
          result.status = 'error';
          result.statusMessage = 'Error occurred during creating metadatum in ChallengeService.createChallengeWithRulesAndMetadata(). Error message: ' + metadatum_result.statusMessage;
          return result;
        }
      });
